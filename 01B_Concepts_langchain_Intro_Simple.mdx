# LangChain Key Points?

* langchain python packages to Help build AI (reasoning) applications. 
* LangChain is the Company. langchain is open source supported by a company and a whole ecosystem.
* LangChain ecosystem as a whole includes multiple standalone components.
